...
// ns_updates
mysql_install_table('ns_updates', ['updtype VARCHAR(3) NOT NULL', 'comic VARCHAR(100) NOT NULL', 'user INT(10) NOT NULL', 'title VARCHAR(100) NOT NULL', 'text TEXT NOT NULL', 'imgtype VARCHAR(5) NOT NULL', 'ip VARCHAR(45) NOT NULL', 'published INT(1) NOT NULL', 'pubtime TIMESTAMP NULL', 'regtime TIMESTAMP NULL', 'updtime TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP', 'visible INT(1) NOT NULL']);
?>